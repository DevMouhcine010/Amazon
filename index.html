...
<head>
	<meta charset="utf-8">
	<!-- SITE TITLE -->
	<title>Blaster Responsive Template</title>
<!--
...
<section class="navbar navbar-fixed-top custom-navbar" role="navigation">
	<div class="container">
		<div class="navbar-header">
			...
			<a href="#" class="navbar-brand"><span class="bold" style="font-style:Cursive;">ASla TEch</span></a>
		</div>
		<div class="collapse navbar-collapse">
			<ul class="nav navbar-nav navbar-right">
				<li><a href="#home" class="smoothScroll">Accueil</a></li>
				<li><a href="#about" class="smoothScroll">Nos services</a></li>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 col-sm-12">
				<hr>
				<h3><span class="bold" style="color:white; background-color:; letter-spacing: 11px;">asLA TEch </h3>
				<h1 class="heading" style="color:white;">intégrateur de solutions technologiques</h1>
				<a href="#about" class="smoothScroll btn btn-default" style="color:white;">Explorer</a>
			</div>
		</div>
	</div>		
</section>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 col-sm-12 text-center">
				<h6 class="heading bold" style="font-size:44px;">Nos services  </h6>
				<h2 class="subheading">ASLA TECH intégre des systèmes et services</h2>
			</div>
			...
			<div class="col-lg-4 col-md-4 col-sm-4 wow fadeInUp" data-wow-delay="0.6s">
				<i class="fa fa-cloud"></i>
					...
					<h4>- Détection intrusion</h4>
					<h4>- Solutions domotique</h4>
			...
			<div class="col-lg-4 col-md-4 col-sm-4 wow fadeInUp" data-wow-delay="0.9s">
				<i class="fa fa-laptop"></i>
					<h4>- Système Incendie </h4>
					<h4>- Clôtures et portails  </h4>
					<h4>- Interphonie et Vidéophonie </h4>
					<h4>- Cybersécurité </h4>

					<!-- <p>Example: <a href="#about">&lt;i class=&quot;fa fa-phone&quot;&gt;&lt;/i&gt;</a> for phone icon. <a href="#about">&lt;i class=&quot;fa fa-mobile&quot;&gt;&lt;/i&gt;</a> for mobile icon. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat.</p> -->
			</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 col-sm-12 text-center">
				...
				<h2 class="subheading">Nous aimons beaucoup avoir de vos nouvelles.</h2>
			</div>
		</div>
		<div class="row">
			...
			<div class="contact-info-box col-md-4 col-sm-4 col-xs-6 wow fadeInUp" data-wow-delay="0.8s">
				<i class="fa fa-envelope-o"></i>
					<h3>aslatech@company.com</h3>
			</div>
			<div class="contact-info-box col-md-4 col-sm-4 col-xs-6 wow fadeInUp" data-wow-delay="1s">
				<i class="fa fa-map-marker"></i>
					<h3>Rue de Taza, Lot Bouziane, N° 14, 3ème étage, Oujda, Oujda, Morocco</h3>
			</div>
		</div>
		<div class="row">
			<div class="col-md-12 col-sm-12">
				<form action="#" method="post">
					...
					<div class="col-md-offset-4 col-md-4 col-sm-offset-4 col-sm-6">
						<input name="submit" type="submit" class="form-control" id="submit" value="Envoyer Message">
					</div>
				</form>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-12 col-sm-12">
				<ul class="social-icon">
					<li><a href="https://www.facebook.com/ASLA.TECH.Formation/" 
	...
	<div class="container">
		<div class="row">
			<div class="col-md-8 col-sm-8 col-xs-9">
				<p>Copyright © 2025 ASLA TECH SARL</p>
			</div>
			<div class="col-md-4 col-sm-4 col-xs-3" style=" text-align: right;">
